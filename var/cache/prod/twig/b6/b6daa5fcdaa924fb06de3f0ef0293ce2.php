...
class __TwigTemplate_316b7ee01511248c8dbf4c580ca03485 extends Template
{
...
";
            ...
            // line 7
            yield "    ";
            if ((($tmp =  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["field"] ?? null), "customOptions", [], "any", false, false, false, 7), "get", ["relatedUrl"], "method", false, false, false, 7))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                // line 8
                yield "        <a href=\"";
    ...
    {
        return new Source("", "@EasyAdmin/crud/field/association.html.twig", "C:\\wamp64\\www\\appac\\vendor\\easycorp\\easyadmin-bundle\\templates\\crud\\field\\association.html.twig");
    }
}
