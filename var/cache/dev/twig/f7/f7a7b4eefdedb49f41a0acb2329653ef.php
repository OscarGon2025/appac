...
class __TwigTemplate_20f5e65df739ec932be9c66643a53b34 extends Template
{
...
";
    ...
    if (typeof Sfjs === 'undefined' || typeof Sfjs.loadToolbar === 'undefined') {
        ...
        if (array_key_exists("excluded_ajax_paths", $context)) {
            ...
            // line 317
            yield json_encode(($context["excluded_ajax_paths"] ?? null));
            yield "))) {
                        var method = 'GET';
            ...
            if (window.XMLHttpRequest && XMLHttpRequest.prototype.addEventListener) {
                ...
                XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
                    ...
                    if (url.slice(0, 1) === '/') {
                        if (0 === url.indexOf('";
            // line 360
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 360), "js"), "html", null, true);
            yield "')) {
                            path = url.slice(";
            // line 361
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 361)), "html", null, true);
            yield ");
                        }
                    }
                    else if (0 === url.indexOf('";
            // line 364
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, false, 364) . CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 364)), "js"), "html", null, true);
            yield "')) {
                        path = url.slice(";
            // line 365
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), (CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "schemeAndHttpHost", [], "any", false, false, false, 365) . CoreExtension::getAttribute($this->env, $this->source, ($context["request"] ?? null), "basePath", [], "any", false, false, false, 365))), "html", null, true);
            yield ");
                    }
...
";
    ...
    {
        return array (  720 => 630,  688 => 601,  597 => 513,  479 => 397,  447 => 368,  441 => 365,  437 => 364,  431 => 361,  427 => 360,  381 => 317,  360 => 298,  358 => 297,  71 => 18,  60 => 13,  55 => 10,  53 => 8,  52 => 3,  48 => 2,  45 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@WebProfiler/Profiler/toolbar_js.html.twig", "C:\\wamp64\\www\\appac\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\toolbar_js.html.twig");
    }
}
