...
class __TwigTemplate_cf592a88119fcb018d7aab4bb763f7fb extends Template
{
...
<html lang=\"en\">
    <head>
        ...
        ";
        // line 10
        $context["request_collector"] = ((array_key_exists("profile", $context)) ? (((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, true, false, 10), "request", [], "any", true, true, false, 10)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["profile"] ?? null), "collectors", [], "any", false, false, false, 10), "request", [], "any", false, false, false, 10), null)) : (null))) : (null));
        // line 11
        yield "        ";
        $context["status_code"] = (((($tmp =  !(null === ($context["request_collector"] ?? null))) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (((CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", true, true, false, 11)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, ($context["request_collector"] ?? null), "statuscode", [], "any", false, false, false, 11), 0)) : (0))) : (0));
        // line 12
        yield "        ";
        ...
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["favicon_color"] ?? null), "html", null, true);
...
";
    ...
    {
        return array (  216 => 46,  208 => 23,  198 => 22,  187 => 18,  178 => 17,  168 => 16,  160 => 24,  158 => 22,  155 => 21,  152 => 16,  142 => 15,  125 => 8,  115 => 47,  113 => 46,  87 => 27,  83 => 25,  81 => 15,  75 => 13,  72 => 12,  69 => 11,  67 => 10,  62 => 8,  55 => 4,  50 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@WebProfiler/Profiler/base.html.twig", "C:\\wamp64\\www\\appac\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Profiler\\base.html.twig");
    }
}
