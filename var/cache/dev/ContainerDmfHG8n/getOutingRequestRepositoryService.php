 ...
 */
class getOutingRequestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OutingRequestRepository' shared autowired service.
     *
     * @return \App\Repository\OutingRequestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OutingRequestRepository.php';

        return $container->privates['App\\Repository\\OutingRequestRepository'] = new \App\Repository\OutingRequestRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
