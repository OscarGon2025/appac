 ...
 */
class getClassifiedAdRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClassifiedAdRepository' shared autowired service.
     *
     * @return \App\Repository\ClassifiedAdRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClassifiedAdRepository.php';

        return $container->privates['App\\Repository\\ClassifiedAdRepository'] = new \App\Repository\ClassifiedAdRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
